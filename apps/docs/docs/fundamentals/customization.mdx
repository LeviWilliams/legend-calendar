...
Check out the full source code [here](https://github.com/LeviWilliams/legend-calendar/blob/main/apps/example/src/components/ThemeableCalendar/LinearCalendar.tsx#L89).
...
<VStack spacing={12} alignItems="center">
  <VStack spacing={4} alignItems="center">
    ...
    <span style={{ fontWeight: "bold" }}>Windows XP calendar • [source code](https://github.com/LeviWilliams/legend-calendar/blob/main/apps/example/src/components/ThemeableCalendar/WindowsXpCalendar/WindowXpCalendar.tsx)</span>
    <span style={{ opacity: 0.8 }}>A nostalgic rebuild to showcase what's possible with Legend Calendar.</span>
...
<VStack spacing={12} alignItems="center">
  <VStack spacing={4} alignItems="center">
    ...
    <span style={{ fontWeight: "bold", margin: 0 }}>Perf calendar • [source code](https://github.com/LeviWilliams/legend-calendar/blob/main/apps/example/src/components/PerfTestCalendar/PerfTestCalendar.stories.tsx)</span>
